<div class="list-group">
    ...
    <?php else: ?>
    <a data-toggle="collapse" data-target="#customize-content" class="list-group-item <?php echo e($activeListGroupItem == 'customization' ? 'active main-color-bg' : ''); ?>" aria-expanded="true">
        <i class="fa fa-paint-brush" aria-hidden="true"></i>Customize <span class="caret"></span>     
    </a>
    <div id="customize-content" class="collapse in" aria-expanded="true">
    <?php endif; ?>
    
        <div class="customize-content-item"><a href="/admin/customize/general" class="list-group-item <?php echo e($activeListGroupItem == 'general' ? 'active main-color-bg' : ''); ?>">
            General</a></div>
        <div class="customize-content-item"><a href="/admin/customize/navbar" class="list-group-item <?php echo e($activeListGroupItem == 'navbar' ? 'active main-color-bg' : ''); ?>">
            Navbar</a></div>
        <div class="customize-content-item"><a href="/admin/customize/header" class="list-group-item <?php echo e($activeListGroupItem == 'header' ? 'active main-color-bg' : ''); ?>">
            Header</a></div>
        <div class="customize-content-item"><a href="/admin/customize/footer" class="list-group-item <?php echo e($activeListGroupItem == 'footer' ? 'active main-color-bg' : ''); ?>">
            Footer</a></div>  
        <div class="customize-content-item"><a href="/admin/customize/themes" class="list-group-item <?php echo e($activeListGroupItem == 'themes' ? 'active main-color-bg' : ''); ?>">
            Themes</a></div> 
    </div> 
